...
router.route('/verify').post(validateBody(schemas.emailAuth), userController.verifyEmail);
router.route('/verify/:userId').patch(passport.authenticate('jwt', { session: false }), userController.verifyPassword);
